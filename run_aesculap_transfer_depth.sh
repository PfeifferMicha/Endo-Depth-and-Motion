...
#for patient in 2021_06_07 2021_06_15 2021_06_23 2021_06_30 2021_07_14 2021_08_31
#for patient in 2021_04_14
for patient in 2021_04_19 2021_04_26 2021_05_27 2021_06_07 2021_06_15 2021_06_23 2021_06_30 2021_07_14 2021_08_31
do
    ...
    if [ -d "$patient_orig_path" ]; then
        ...
        cd ~/Projects/IntraoperativeReconstruction/transfer-depth
        conda init
        conda activate transfer-depth
        python3 run.py $patient_output_path/color $patient_output_path/transfer-depth #--rescale $patient_output_path/depth
        ...
        python3 apps/tracking_ours/__main__.py -d cuda:0 --input_scene_directory $patient_output_path -o $patient_output_path/tracking --no_vis_3d --no_vis_2d --depth_folder transfer-depth
        ...
        echo "Volume fusion:"
        echo "================================"
        python3 apps/volumetric_fusion/__main__.py -i $tracking_result -o data/Aesculap/$patient/ --depth_folder transfer-depth
    fi
